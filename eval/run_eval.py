...
# `REVIEW_MODE=single-agent` with REVIEW_LENSES unset is five single-agent
# lenses, not one, so a results file naming only the mode cannot say what it
# measured. Recording the resolved dials makes each results JSON self-describing.
REVIEW_CONFIG_VARS = (
    "REVIEW_MODE",
    "REVIEW_LENSES",
    "REVIEW_FANOUT",
