...
- The combination of own-PR review and the identity model from [ADR 0003](./0003-identity-model.md) means own-PR reviews appear as self-reviews under the operator's account, marked as AI-drafted by the `🤖` body marker. The pending gate prevents accidental publication of unwanted findings.
